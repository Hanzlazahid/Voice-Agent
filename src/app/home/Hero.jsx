...
const HeroSection = () => {
    ...
    return (
        <div className="bg-black relative overflow-hidden flex items-center justify-center py-20 md:py-44">
            ...
            {/* Demo content to show seamless transition */}
            <div className="absolute -bottom-96 left-0 right-0 bg-black h-96 flex items-center justify-center">
                <p className="text-white text-xl">Next section content goes here...</p>
            </div>
        </div>
    );
};
